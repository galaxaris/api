...
class Entity(GameObject):
    ...
    def __init__(self, pos: tuple[int, int] | pg.Vector2, size: tuple[int, int], max_velocity: float|int = 2, acceleration: float|int = 0.5, resistance:float|int = 0.2, force:float|int = 20):
        """
